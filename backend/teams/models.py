...
from neomodel import (StringProperty, IntegerProperty, DateProperty, StructuredRel,RelationshipFrom, BooleanProperty,UniqueIdProperty, RelationshipTo, One, ZeroOrOne)
...
class TEAM(DjangoNode):
    ...
    city_name = RelationshipTo('cities.models.CITY', 'CITY_BASED_IN',cardinality=ZeroOrOne)
    state_name = RelationshipTo('states.models.STATE', 'STATE_BASED_IN',cardinality=ZeroOrOne)
    country_name = RelationshipTo('countries.models.COUNTRY', 'COUNTRY_BASED_IN',cardinality=ZeroOrOne)

...
class ACTIVITY(DjangoNode):
    ...
    city = RelationshipTo('cities.models.CITY', 'BASED_IN',cardinality=ZeroOrOne)
    state = RelationshipTo('states.models.STATE', 'BASED_IN',cardinality=ZeroOrOne)
    country = RelationshipTo('countries.models.COUNTRY', 'BASED_IN',cardinality=ZeroOrOne)

...
const Globe = () => {
  ...
  const colors = ['#E0643C', '#3b82f6', '#6366f1'];
  const sampleArcs = [
    {
      order: 1,
      startLat: -19.885592,
  ...
  return (
    <div className="flex flex-row items-center justify-center h-screen md:h-auto relative w-full ">
      <div className="max-w-7xl mx-auto w-full relative overflow-hidden h-full md:h-[40rem] px-4  ">
        ...
        >
          <h2 className="text-center text-xl md:text-4xl font-bold fixed block  top-28">
            <span className="text-primary">Events</span> around the world!
          </h2>
        </motion.div>

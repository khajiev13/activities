...
export default function Navbar() {
  ...
  return (
    <NavigationMenu className="max-w-full min-w-full w-full block">
      <NavigationMenuList className="flex justify-between w-full min-w-full max-w-full px-12">
        <NavigationMenuItem>
        ...
        <NavigationMenuItem>
          <NavigationMenuTrigger onClick={() => navigate('/activities')}>
            Activities
          </NavigationMenuTrigger>
          <NavigationMenuContent>
            <ul className="grid gap-3 p-6 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]">
              ...
              <ListItem href="/activities/outdoors" title="Outdoor Activities">
                Outdoor activities can be football, basketball, tennis, etc.
              </ListItem>
              <ListItem href="/activities/indoors" title="Indoor Activities">
